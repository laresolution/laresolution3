<template>
  <div class="container my-5">
    <div class="TitleH1">
    <h1>
      Liste des Sites web de la Résolution!
    </h1>
  </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <li
            ...
            <div class="col-md-9" style="text-align:left;"><span style="cursor: pointer" :class="{ done: todo.done }">{{ todo.todo }}</span>
            </div>
            <div class="col-md-2">
  ...
  <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" data-onstyle="#1f2023">
            ...
            <div class="col-md-1">
              <div class="Delete"><button @click="delete_ToDo(index)">Supprimer</button>
            </div>
            </div>            
            </li>
          </ul>
...
.TitleH1 {
    ...
    text-align: center;
    color: black;
    border: 33px solid #a0a4d9;
}
.Todo {
    font-weight: 700; font-size: 15px; color: black
}
.Input{
